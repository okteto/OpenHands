...
build-okteto:
	...
	@OKTETO_LOCAL_REGISTRY_STORE_PRIORITY_ENABLED=true okteto build -f Dockerfile -t okteto/cindy-sandbox:0.28.0-okteto-10 .
	@OKTETO_LOCAL_REGISTRY_STORE_PRIORITY_ENABLED=true okteto build -f containers/app/Dockerfile -t okteto/cindy-agent:0.28.0-okteto-10 .
